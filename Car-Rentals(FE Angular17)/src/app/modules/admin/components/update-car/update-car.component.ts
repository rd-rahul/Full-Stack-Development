...
export class UpdateCarComponent {
  ...
  employees=["Ryan", "Mindy","Roy", "Michael","Pam","Jim","Dwight"];
  dealerships=["D1", "D2", "D3", "D4"];
  ...
  updateCar() {
    ...
    formData.append('employee', this.updateForm.get('employee').value);
    formData.append('dealership', this.updateForm.get('dealership').value);
